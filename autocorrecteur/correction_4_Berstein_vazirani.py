...
def correction_fonction(func):
    ...
    if isinstance(result, dict) and all(isinstance(v, np.ndarray) for v in result.values()):
        ...
        cas_de_test = [('000', np.array([1.,0.,0.,0.,0.,0.,0.,0.])), 
                ('001', np.array([0.,0.,1.,0.,0.,0.,0.,0.])), 
                ('010', np.array([0.,1.,0.,0.,0.,0.,0.,0.])),
                ('011', np.array([0.,1.,1.,0.,0.,0.,0.,0.])),
                ('100', np.array([0.,0.,0.,1.,0.,0.,0.,0.])), 
                ('101', np.array([0.,0.,0.,1.,1.,0.,0.,0.])),
                ('110', np.array([0.,0.,0.,1.,1.,1.,0.,0.])),
                ('111', np.array([0.,0.,0.,1.,1.,1.,1.,0.]))]
